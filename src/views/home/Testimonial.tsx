          ...
          <div class="row g-4">
            <div class="col-lg-6 col-12">
              <div class="testimonial__thumb position-relative">
                <img
                  src={getAssetsUrl() + "assets/images/testimonial/03.jpg"}
                  alt="testimonial"
                />
            ...
            <div class="col-lg-6 col-12">
              <div class="testimonial-slider overflow-hidden swiper-container-initialized swiper-container-horizontal">
                <div
                  class="swiper-wrapper"
                  style="transform: translate3d(-1026px, 0px, 0px); transition-duration: 0ms;"
                >
                  <div
                          ...
                          <div class="testi-top">
                            <div class="testimonial-thumb">
                              <img
                                src={
                                  getAssetsUrl() +
                                  "assets/images/testimonial/01.jpg"
                                }
                                alt="testimonial"
                              />
                            </div>
                          ...
                          <div class="testi-top">
                            <div class="testimonial-thumb">
                              <img
                                src={
                                  getAssetsUrl() +
                                  "assets/images/testimonial/02.jpg"
                                }
                                alt="testimonial"
                              />
                            </div>
